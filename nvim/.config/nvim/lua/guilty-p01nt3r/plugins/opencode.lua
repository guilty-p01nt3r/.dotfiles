return {
  ...
  config = function()
    ...
    vim.keymap.set("n" , "<leader>.", function() require("opencode").toggle() end,                          { desc = "Toggle opencode" })
    --vim.keymap.set("t", "<leader>.", function() require("opencode").toggle() end,                          { desc = "Toggle opencode" })
